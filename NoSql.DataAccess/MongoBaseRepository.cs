...
{
    public class MongoBaseRepository<TDocument> : IMongoBaseRepository<TDocument> where TDocument : IBaseDocument
    {
        private readonly IMongoCollection<TDocument> _collection;

        /// <summary>
        /// Will connect to our Mongo DB, using configuration database value.
        /// </summary>
        ...
        /// <summary>
        /// Get the collection name to use for the <see cref="IBaseDocument"/> via <see cref="MongoCollectionAttribute"/>
        /// </summary>
        ...
        public Task<IEnumerable<TDocument>> FilterByAsync(
            Expression<Func<TDocument, bool>> filterExpression)
        {
        ...
        public Task<IEnumerable<TProjected>> FilterByAsync<TProjected>(
          ...
          , Expression<Func<TDocument, TProjected>> projectionExpression)
        {
            return Task.Run(() => _collection.Find(filterExpression).Project(projectionExpression).ToEnumerable());
        }
